                                ...
                                <div class="col-lg-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                            value="{{ $slider->title }}" name="title" required>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="mt-2" for="merek">Description</label>
                                        <input type="text" class="form-control" id="description"
                                            value="{{ $slider->description }}" name="description" required>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" name="image" class="form-control dropify" accept="image/*"
                                            data-height="200" data-default-file="{{ asset('assets/img/slider/' . $slider->image) }}"  />
                                    </div>
                                </div>
