                                ...
                                <div class="col-lg-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="judul"
                                            value="{{ $project->judul }}" name="judul" required>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="mt-2" for="jenis">Deskripsi</label>
                                        <textarea name="deskripsi" class="form-control" id="" cols="30" rows="10">{{ $project->deskripsi }} </textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" name="gambar" class="form-control dropify" accept="image/*"
                                            data-height="200" data-default-file="{{ asset('assets/img/project/' . $project->gambar) }}"  />
                                    </div>
                                </div>
