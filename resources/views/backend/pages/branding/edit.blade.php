...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="row">
            <form action="{{ route('branding.update', $branding->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                            value="{{ $branding->title }}" name="title" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" name="image" class="form-control dropify" accept="image/*"
                                            data-height="200" data-default-file="{{ asset('assets/img/branding/' . $branding->image) }}"  />
                                    </div>
                                </div>
